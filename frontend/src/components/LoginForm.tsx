...
const LoginForm: React.FC<LoginFormProps> = ({ onLogin, onToggleForm, isLoading, error }) => {
  ...
  return (
    <div className="min-h-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Sign in to your NoteLog account</p>
        </div>
